    ...
    <section
        ...
        <div>
            ...
            >
                ...
                <x-slot:title>{{ __('Search Messages') }}</x-slot:title>
                <x-slot:icon>
        ...
        <div class="bm-flex bm-h-96 bm-grow bm-flex-col bm-overflow-y-auto bm-px-3">
            <div class="bm-my-3 bm-flex bm-flex-col bm-gap-y-3">
                ...
                >
                    <span x-show="isLoadingShowMore === false">{{ __('Load more messages') }}</span>
                                    ...
                                    <template x-if="message.receiverId === receiver.id">
                                        <div class="bm-w-[10%]">
                                            <x-basement::atoms.buttons.secondary
                                                ...
                                                data-title="{{ __('Manage this message') }}"
        ...
        >
            ...
            <x-basement::molecules.form-group class="bm-col-span-7">
                <x-slot:title>{{ __('Message') }}</x-slot:title>
